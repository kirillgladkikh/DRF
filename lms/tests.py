...
class LessonCRUDTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.owner_user = User.objects.create(email="owner@example.com", password="testpass123")
        # Устанавливаем корректный пароль (create не хэширует пароль автоматически)
        self.owner_user.set_password("testpass123")
        self.owner_user.save()

        self.moderator_user = User.objects.create(email="moderator@example.com", password="testpass123")
        self.moderator_user.set_password("testpass123")
        self.moderator_user.save()

        self.other_user = User.objects.create(email="other@example.com", password="testpass123")
        ...
        self.course = Course.objects.create(
            course_name="Тестовый курс", course_description="Описание тестового курса", owner=self.owner_user
        )
