...
class SubscriptionTests(APITestCase):
    def setUp(self):
        ...
        self.moderator = User.objects.create(email="moderator@example.com", password="testpass123")
        ...
        self.course1 = Course.objects.create(
            course_name="Курс 1", course_description="Описание курса 1", owner=self.user1
        )

        self.course2 = Course.objects.create(
            course_name="Курс 2", course_description="Описание курса 2", owner=self.user2
        )
    ...
    def test_subscribe_as_moderator(self):
        ...
        data = {"course_id": self.course2.pk}
        response = self.client.post(self.subscription_url, data, format="json")
    ...
    def test_subscribe_to_course_owned_by_user(self):
        ...
        self.client.force_authenticate(user=self.user1)
        data = {"course_id": self.course1.pk}  # user1 — владелец курса
        response = self.client.post(self.subscription_url, data, format="json")
