...
from users.views import (SubscriptionAPIView, UserCreateAPIView, UserDestroyApiView, UserListApiView,
                         UserRetrieveApiView, UserUpdateApiView, payment_callback)
