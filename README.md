...
## МОДУЛЬ: Django
ДОМАШНЕЕ ЗАДАНИЕ 32.2 Документирование и безопасность (feature/dz32_2)

## ДЗ32.2
### Задание 1
- Подключить и настроить вывод документации для проекта.
### Задание 2
- Подключить возможность оплаты курсов через stripe.com.
...
- Поля (пользователь, оплаченный курс, оплаченный урок) должны быть ссылками на соответствующие модели.
- Запишите в таблицу, соответствующую этой модели данные через кастомную команду.
### Задание 3
